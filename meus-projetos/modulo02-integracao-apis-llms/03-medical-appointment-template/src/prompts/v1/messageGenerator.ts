...
export const getSystemPrompt = () => {
  return JSON.stringify({
    ...
    scenarios: {
      ...
      reschedule_success: 'Confirm the new appointment date/time and mention the old one when available',
...
export const getUserPromptTemplate = (data: any) => {
  return JSON.stringify({
    ...
    examples: {
      ...
      reschedule_success: 'Sua consulta foi remarcada com sucesso para o novo horário solicitado. Se precisar, posso ajudar com outro ajuste.',
      reschedule_error: 'Não consegui remarcar sua consulta com as informações atuais. Por favor, confirme o horário atual e o novo horário desejado.',
